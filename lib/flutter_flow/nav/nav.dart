...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CollectionListWidget.routeName,
          path: CollectionListWidget.routePath,
          builder: (context, params) => CollectionListWidget(),
        ),
        FFRoute(
          name: CloseCollectionWidget.routeName,
          path: CloseCollectionWidget.routePath,
          builder: (context, params) => CloseCollectionWidget(),
        ),
        FFRoute(
          name: SubmitCollectionWidget.routeName,
          path: SubmitCollectionWidget.routePath,
          builder: (context, params) => SubmitCollectionWidget(),
        ),
        FFRoute(
          name: CollectionRecieptWidget.routeName,
          path: CollectionRecieptWidget.routePath,
          builder: (context, params) => CollectionRecieptWidget(
            ...
            shadowBalance: params.getParam(
              'shadowBalance',
              ParamType.String,
            ),
            acAge: params.getParam(
              'acAge',
              ParamType.String,
            ),
            lastNvDate: params.getParam(
              'lastNvDate',
              ParamType.String,
            ),
            openDate: params.getParam(
              'openDate',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: MemberListPageWidget.routeName,
          path: MemberListPageWidget.routePath,
