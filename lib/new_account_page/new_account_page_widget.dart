...
class NewAccountPageWidget extends StatefulWidget {
  const NewAccountPageWidget({super.key});

  static String routeName = 'NewAccountPage';
  static String routePath = '/newAccountPage';

  @override
  State<NewAccountPageWidget> createState() => _NewAccountPageWidgetState();
}
...
class _NewAccountPageWidgetState extends State<NewAccountPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldAcNoTextController ??= TextEditingController(
        text: NewMemberCall.acNo(
      (_model.newMemberResponse?.jsonBody ?? ''),
    )?.toString());
    ...
    _model.textFieldCustIdTextController ??=
        TextEditingController(text: FFAppState().CustId);
    _model.textFieldCustIdFocusNode ??= FocusNode();

    _model.textFieldNameTextController ??=
        TextEditingController(text: FFAppState().CustEName);
    _model.textFieldNameFocusNode ??= FocusNode();

    _model.textFieldMobNoTextController ??=
        TextEditingController(text: FFAppState().CustMobNo);
    _model.textFieldMobNoFocusNode ??= FocusNode();
                    ...
                    children: [
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.textFieldCustIdTextController,
                                    focusNode: _model.textFieldCustIdFocusNode,
                                    autofocus: false,
                                    readOnly: _model.btnSubmit == true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: (_model.btnSubmit == true)
                                      ? null
                                      : () async {
                                          if (_model.textFieldCustIdTextController
                                                      .text !=
                                                  '') {
                                            _model.getCustomerResponse =
                                                await GetCustomerCall.call(
                                              serverAddress:
                                              ...
                                              customerId: _model
                                                  .textFieldCustIdTextController
                                                  .text,
                                            );

                                            if ((_model.getCustomerResponse
                                                    ?.succeeded ??
                                                true)) {
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: (_model.btnSubmit == true)
                                      ...
                                      : () async {
                                          context.pushNamed(
                                              GetCustomerListWidget.routeName);
                                        },
                                ),
                              ),
                            ),
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          child: TextFormField(
                            controller: _model.textFieldMobNoTextController,
                            focusNode: _model.textFieldMobNoFocusNode,
                            autofocus: false,
                            readOnly: _model.btnSubmit == true,
                            obscureText: false,
                            decoration: InputDecoration(
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          child: TextFormField(
                            controller: _model.textFieldCollAmtTextController,
                            ...
                            decoration: InputDecoration(
                              isDense: true,
                              labelText: FFLocalizations.of(context).getText(
                                'kenyxzzb' /* Enter Collection Amount */,
                              ),
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                          ...
                          child: FFButtonWidget(
                            onPressed: (_model.btnSubmit == true)
                                ...
                                : () async {
                                    ...
                                    _model.newMemberResponse =
                                        await NewMemberCall.call(
                                      ...
                                      token: FFAppState().token,
                                      customerId: _model
                                          .textFieldCustIdTextController.text,
                                      memberName: _model
                                          .textFieldNameTextController.text,
                                      collectionAmt: _model
                                          .textFieldCollAmtTextController.text,
                                      memMobileNo: _model
                                          .textFieldMobNoTextController.text,
                                    );

                                    if ((_model.newMemberResponse?.succeeded ??
                                        true)) {
                                      if (NewMemberCall.flag(
                                            (_model.newMemberResponse
                                                    ?.jsonBody ??
                                                ''),
                                          ) ==
