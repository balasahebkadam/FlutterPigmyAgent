...
class _CollectionRecieptWidgetState extends State<CollectionRecieptWidget> {
  ...
  void initState() {
    ...
    _model.textFieldShadowBalTextController ??=
        TextEditingController(text: widget.shadowBalance);
    ...
    _model.textFieldOpenDateTextController ??=
        TextEditingController(text: widget.openDate);
    ...
    _model.textFieldLastDrDateTextController ??=
        TextEditingController(text: widget.lastNvDate);
    ...
    _model.textFieldAccountAgeTextController ??=
        TextEditingController(text: widget.acAge);
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.textFieldReciptNoFocusNode,
                                    autofocus: false,
                                    readOnly: true,
                                    obscureText: false,
                                    ...
                                    child: TextFormField(
                                      ...
                                      readOnly: () {
                                        if (_model.isBtnPressed == true) {
                                          return true;
                                        } else if (_model.acNoDisable == true) {
                                          return true;
                                        } else {
                                          return false;
                                        }
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: (_model.isBtnPressed == true)
                                      ? null
                                      : () async {
                                          if (_model.textFieldAcNoTextController
                                                      .text !=
                                                  '') {
                                            ...
                                            if ((_model.memberAcResponse
                                              ...
                                              if (MemberListCall.flag(
                                                ...
                                                safeSetState(() {
                                                  _model
                                                      .textFieldShadowBalTextController
                                                      ?.text = MemberListCall
                                                          .shadowBalance(
                                                    (_model.memberAcResponse
                                                            ?.jsonBody ??
                                                ...
                                                safeSetState(() {
                                                  _model
                                                      .textFieldOpenDateTextController
                                                      ?.text = MemberListCall
                                                          .openDate(
                                                    (_model.memberAcResponse
                                                            ?.jsonBody ??
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.textFieldRemarkFocusNode,
                                      autofocus: false,
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.textFieldCollAmtFocusNode,
                                      autofocus: false,
                                      readOnly: _model.isBtnPressed == true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        ...
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'zuoxbx0p' /* Enter Collection Amount */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                      ...
                                      : () async {
                                          ...
                                          if ((_model
                                            ...
                                            if (ReceiptCall.flag(
                                              ...
                                              safeSetState(() {
                                                _model
                                                    .textFieldReciptNoTextController
                                                    ?.text = ReceiptCall.trnNo(
                                                  (_model.recieptResponse
                                                          ?.jsonBody ??
                                                      ''),
